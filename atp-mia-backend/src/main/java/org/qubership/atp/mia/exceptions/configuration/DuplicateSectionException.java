...
@ResponseStatus(value = HttpStatus.INTERNAL_SERVER_ERROR, reason = "MIA-0071")
public class DuplicateSectionException extends MiaException {

    public DuplicateSectionException(String sectionName) {
        super(ErrorCodes.MIA_0071_SECTION_DUPLICATION, sectionName);
    }
}
