...
@ResponseStatus(value = HttpStatus.INTERNAL_SERVER_ERROR, reason = "MIA-0066")
public class SectionNotFoundException extends MiaException {

    public SectionNotFoundException(UUID sectionId) {
        super(ErrorCodes.MIA_0066_SECTION_NOT_FOUND, sectionId);
    }

    public SectionNotFoundException(String sectionName) {
        super(ErrorCodes.MIA_0066_SECTION_NOT_FOUND, sectionName);
    }
}
