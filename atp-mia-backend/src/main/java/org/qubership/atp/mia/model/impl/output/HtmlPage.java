...
public class HtmlPage {
    ...
    /**
     * Html Page output is generated from file.
     *
     * @param internalPathToFile path to output file on local machine
     * @param htmlText           html markup like string
     */
    public HtmlPage(@Nonnull String internalPathToFile, String htmlText, MiaContext miaContext) {
