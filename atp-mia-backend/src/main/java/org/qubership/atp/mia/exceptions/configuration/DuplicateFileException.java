...
@ResponseStatus(value = HttpStatus.INTERNAL_SERVER_ERROR, reason = "MIA-0075")
public class DuplicateFileException extends MiaException {

    public DuplicateFileException(String file) {
        super(ErrorCodes.MIA_0075_FILE_DUPLICATION, file);
    }
}
