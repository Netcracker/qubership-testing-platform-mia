...
@ResponseStatus(value = HttpStatus.INTERNAL_SERVER_ERROR, reason = "MIA-0068")
public class ProcessNotFoundException extends MiaException {

    public ProcessNotFoundException(String processName) {
        super(ErrorCodes.MIA_0068_PROCESS_NOT_FOUND, processName);
    }

    public ProcessNotFoundException(UUID processId) {
        super(ErrorCodes.MIA_0068_PROCESS_NOT_FOUND, processId);
    }
}
