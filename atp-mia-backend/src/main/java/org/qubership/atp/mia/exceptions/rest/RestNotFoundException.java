...
@ResponseStatus(value = HttpStatus.INTERNAL_SERVER_ERROR, reason = "MIA-1409")
public class RestNotFoundException extends MiaException {

    public RestNotFoundException() {
        super(ErrorCodes.MIA_1409_REST_NOT_FOUND);
    }
}
