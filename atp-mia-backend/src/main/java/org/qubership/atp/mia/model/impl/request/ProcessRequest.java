...
public class ProcessRequest {
    ...
    public static ProcessRequest fromProcessConfiguration(ProcessConfiguration process) {
        return new ProcessRequest(process.getName(), process.getProcessSettings().getCommand());
    }
}
