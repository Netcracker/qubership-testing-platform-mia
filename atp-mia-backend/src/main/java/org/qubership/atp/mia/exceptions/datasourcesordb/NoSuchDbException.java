...
@ResponseStatus(value = HttpStatus.INTERNAL_SERVER_ERROR, reason = "MIA-3000")
public class NoSuchDbException extends MiaException {

    public NoSuchDbException(DbType dbType) {
        super(ErrorCodes.MIA_3000_NO_SUCH_DB, dbType);
    }
}
