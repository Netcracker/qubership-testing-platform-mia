...
public class EventExcelMetricService {
    ...
    public static MetricsAggregateService metricsAggregateServiceStatic;
    private final MetricsAggregateService metricsAggregateService;

    public EventExcelMetricService(MetricsAggregateService metricsAggregateService) {
        this.metricsAggregateService = metricsAggregateService;
    }

    @PostConstruct
    public void init() {
        metricsAggregateServiceStatic = this.metricsAggregateService;
    }
}
