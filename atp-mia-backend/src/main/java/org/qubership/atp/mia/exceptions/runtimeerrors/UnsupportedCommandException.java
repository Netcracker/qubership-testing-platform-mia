...
@ResponseStatus(value = HttpStatus.INTERNAL_SERVER_ERROR, reason = "MIA-0002")
public class UnsupportedCommandException extends MiaException {

    public UnsupportedCommandException(String type) {
        super(ErrorCodes.MIA_0002_UNSUPPORTED_COMMAND, type);
    }
}
