...
@ResponseStatus(value = HttpStatus.INTERNAL_SERVER_ERROR, reason = "MIA-1907")
public class PatternCompileException extends MiaException {

    public PatternCompileException(String message) {
        super(ErrorCodes.MIA_1907_PATTERN_COMPILE_EXCEPTION, message);
    }
}
