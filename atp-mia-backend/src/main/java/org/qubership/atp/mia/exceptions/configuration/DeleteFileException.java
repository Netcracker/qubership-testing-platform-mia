...
@ResponseStatus(value = HttpStatus.INTERNAL_SERVER_ERROR, reason = "MIA-0094")
public class DeleteFileException extends MiaException {

    public DeleteFileException(Exception e) {
        super(ErrorCodes.MIA_0094_DELETE_FILE_PROBLEM, e);
    }
}
