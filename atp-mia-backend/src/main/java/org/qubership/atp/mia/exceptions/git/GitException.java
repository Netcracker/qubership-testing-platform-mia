...
@ResponseStatus(value = HttpStatus.INTERNAL_SERVER_ERROR, reason = "MIA-0100")
public class GitException extends MiaException {

    public GitException(GitAPIException e) {
        super(ErrorCodes.MIA_0100_GIT_ERROR, e);
    }

    public GitException(String errorMessage) {
        super(ErrorCodes.MIA_0100_GIT_ERROR, errorMessage);
    }
}
