...
WS_EVENT_SOURCE_HEARTBEAT_TIMEOUT: "{{ .Values.WS_EVENT_SOURCE_HEARTBEAT_TIMEOUT }}"
...
FE_VARIABLES_FILE_PATH: "{{ .Values.FE_VARIABLES_FILE_PATH }}"
FE_VARIABLES_FILE_NAME: "{{ .Values.FE_VARIABLES_FILE_NAME }}"
